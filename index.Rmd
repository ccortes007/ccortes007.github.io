...
slices <- c(880, 530, 359, 177, 117, 78, 74, 185) 
lbls <- c("Sleep", "Leisure Sports", "Working", "Household", "Eating", "Personal Care", "Purchasing", "Other")
pct <- round(slices/sum(slices)*100)
lbls <- paste(lbls, pct) # add percents to labels 
lbls <- paste(lbls,"%",sep="") # ad % to labels 
pie(slices,labels = lbls, col=rainbow(length(lbls)),
    main="Average hours per day spent (2014) U.S.A Department of Labor") 
```
